...
export type ExecutorErrorCode =
  ...
  | 'EXECUTOR_UNSUPPORTED_CAPABILITY' | 'EXECUTOR_WORKSPACE_ERROR';

export class ExecutorError extends Error {
  constructor(readonly code: ExecutorErrorCode, message: string) { super(message); this.name = 'ExecutorError'; }
}
